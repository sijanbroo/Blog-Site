      ...
      <div className="relative min-h-screen flex items-center justify-center px-6">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center mt-30">
          ...
          <div className="flex gap-4 justify-center mb-16">
            <button className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-bold py-4 px-8 rounded-xl shadow-lg shadow-purple-500/50 transition-all transform hover:scale-105">
              {authStatus ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20">
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 hover:bg-white/20 transition-all transform hover:scale-105 shadow-xl">
              ...
              <p className="text-gray-300">
                Create beautiful posts with our powerful editor. Add formatting,
                images, and more.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20 mb-20">
            <div className="text-center">
              <div className="text-5xl font-bold text-transparent bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text mb-2">
                10K+
              </div>
          ...
          {/* CTA Section */}
          <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 backdrop-blur-md border border-white/20 rounded-3xl p-12 mt-20 mb-20">
            ...
            <button className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-bold py-4 px-12 rounded-xl shadow-lg shadow-purple-500/50 transition-all transform hover:scale-105">
              {authStatus ? (
